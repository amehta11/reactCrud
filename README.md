...
3. Install required packages by `npm install`
4. To run the app in development mode by `npm start`. Open [http://localhost:3000](http://localhost:3000) to view it in the browser.
